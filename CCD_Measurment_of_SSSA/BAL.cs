...
namespace CCD_Measurment_of_SSSA
{
    class BAL
    {
        ...
        public void AddModel(string model_name, string model_date, string master_value, string CCD_Value, string shim_verification_tolerence)
        {
            string str = "insert into tbl_ModelMaster (model_name,model_date,master_value,CCD_Value, shim_verification_tolerence ) values ('" + model_name + "','" + model_date + "','" + master_value + "','" + CCD_Value + "','" + shim_verification_tolerence + "')";
        ...
        public void UpdateModel(string ID, string model_name, string model_date,string master_value, string CCD_Value, string shim_verification_tolerence)
        {
            string str = " UPDATE tbl_ModelMaster SET model_name='" + model_name + "',model_date='" + model_date + "', master_value='" + master_value + "',CCD_Value ='" + CCD_Value + "' ,  shim_verification_tolerence='" + shim_verification_tolerence + "'  WHERE (ID=" + ID + ")";
            _objSQLHelper.ExecuteSql(str);
        }
        //tbl_shim//
        ...
        internal void AddPTOMeasurementData(string  modelid,string master_value, string dialguage_reading, string actual_reading, string ccd_value, string spline_shaft_etched_value, string BH_from_OC_To_IR, string shim_required, string total_shims, string shim_required_verification, string operator_name, DateTime  createdate)
        {
            string str = "insert into tbl_PTOMeasurementMaster (modelid,master_value, dialguage_reading,actual_reading,ccd_value,spline_shaft_etched_value,BH_from_OC_To_IR,shim_required,total_shims,shim_required_verification,operator_name,createdate ) values ('" + modelid + "','" + master_value + "','" + dialguage_reading + "','" + actual_reading + "','" + ccd_value + "','" + spline_shaft_etched_value + "','" + BH_from_OC_To_IR + "','" + shim_required + "','" + total_shims + "','" + shim_required_verification + "','"+operator_name+"','" + createdate + "')";
            _objSQLHelper.ExecuteSql(str);
        }
